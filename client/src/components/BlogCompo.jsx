    ...
    >
      <div className="max-w-4xl mx-auto px-6 py-10">
        ...
        <div className="flex flex-wrap items-center gap-4 text-sm text-gray-600 dark:text-gray-400 mb-6">
          ...
          <span
            className="cursor-pointer px-3 py-1 text-xs bg-amber-400 text-white rounded-full"
            onClick={() => handleEdit()}
          >
            <PencilLine />
          </span>
          ...
          {user?._id == blog.author?._id && (
            <span
              className="cursor-pointer px-3 py-1 text-xs bg-red-600/80 text-white rounded-full"
